...
import CoursesInReviewComponent from '../../frontend/reactComponents/courses/coursesInReview/index';
import { handleAuthentication } from '../../globalHelpers/handleAuthentication';

const CoursesInReview = ({ auth, coursesInReview }) => (
  <div>
    <Head>
    ...
    <CoursesInReviewComponent coursesInReview={ coursesInReview } auth={ auth } />
  </div>
);
